...
(def projects
  [{:name "Clojure Darts Scoreboard" :img-src "imgs/501-cljs.jpg" :language "Clojurescript" :repo-link "https://github.com/pramza427/darts-reframe" :web-link "https://pramza427.github.io/darts-reframe/"
   ...
   {:name "Darts Scoreboard" :img-src "imgs/501.jpg" :language "HTML, Javascript" :repo-link "https://github.com/pramza427/Dart-Games" :web-link "https://pramza427.github.io/Dart-Games/501.html" :description "A quick and easy way for users to keep track of scores in dart games"}
   {:name "HighwayRush" :img-src "imgs/HighwayRush.jpg" :language "HTML, Javascript" :repo-link "https://github.com/pramza427/IT202-Spring2021-project2" :web-link "https://pramza427.github.io/IT202-Spring2021-project2" :description "A downloadable side scroller where you race down the highway avoiding other cars and picking up gas to try and get the highest score"}
   {:name "RecipeFinder" :img-src "imgs/RecipeFinder.jpg" :language "HTML, Javascript" :repo-link "https://github.com/pramza427/RecipeFinder" :web-link "https://pramza427.github.io/RecipeFinder/index.html" :description "Uses a recipe API to quickly and easily filter through recipes and display them to the user"}
   {:name "Auto Reviews" :img-src "imgs/AutoReviews.jpg" :language "HTML, Javascript, Python" :repo-link "https://github.com/pramza427/Review-Generator" :web-link "https://pramza427.github.io/Review-Generator/" :description "Fun little project that took Disneyland reviews to create a markov model and used that to generate reviews based on which star rating the user chooses"}
   {:name "Craft Piggy Bank" :img-src "imgs/craft-piggy-bank.jpg" :language "Clojurescript" :repo-link "https://github.com/pramza427/craft-piggy-bank" :web-link "https://pramza427.github.io/craft-piggy-bank/" :description "Track your time doing projects and \"earn\" money to spend on your hobbies"}])
